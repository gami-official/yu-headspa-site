...
export function Hero() {
  return (
    <section className="relative h-[88vh] min-h-[640px] overflow-hidden md:h-screen">
      <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-zinc-900">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center px-5">
          <div className="pointer-events-auto w-full max-w-[360px] text-center sm:max-w-3xl">
            <motion.p
